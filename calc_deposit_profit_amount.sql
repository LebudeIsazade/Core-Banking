...
begin
   select term,interest_rate into v_term,v_interest_rate from CB_DEPOSIT_PRODUCTS 
     where product_name='Novruz emaneti ';
   
   calc_deposit_profit_amount(v_deposit_amount,v_interest_rate,v_term,v_profit_amount);
   cb_customer_deposit_insert(1,1,'00009',v_deposit_amount,v_profit_amount ,sysdate);
end;


select * from cb_deposit_products where product_name='Novruz emaneti';
